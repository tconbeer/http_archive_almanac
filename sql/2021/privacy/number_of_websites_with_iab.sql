...
select
    *,
    ...
    / number_of_websites as pct_websites_with_iab_tcf_v1,
    number_of_websites_with_iab_tcf_v2
    / number_of_websites as pct_websites_with_iab_tcf_v2,
    number_of_websites_with_iab_tcf_v1_compliant
    / number_of_websites_with_iab_tcf_v1 as pct_websites_with_iab_tcf_v1_compliant,
    number_of_websites_with_iab_tcf_v2_compliant
    / number_of_websites_with_iab_tcf_v2 as pct_websites_with_iab_tcf_v2_compliant,
    number_of_websites_with_iab_tcf_any
    / number_of_websites as pct_websites_with_iab_tcf_any,
...
from
    (
        select
            ...
            countif(
                json_value(metrics, '$.iab_tcf_v1.present') = 'true'
                or json_value(metrics, '$.iab_tcf_v2.present') = 'true'
            ...
            countif(
                json_value(metrics, '$.iab_tcf_v1.present') = 'true'
                or json_value(metrics, '$.iab_tcf_v2.present') = 'true'
                or json_value(metrics, '$.iab_usp.present') = 'true'
            ) as number_of_websites_with_iab_any,
            countif(
                json_value(metrics, '$.iab_tcf_v1.present') = 'true'
                and json_value(metrics, '$.iab_tcf_v1.compliant_setup') = 'true'
            ) as number_of_websites_with_iab_tcf_v1_compliant,
            countif(
                json_value(metrics, '$.iab_tcf_v2.present') = 'true'
                and json_value(metrics, '$.iab_tcf_v2.compliant_setup') = 'true'
