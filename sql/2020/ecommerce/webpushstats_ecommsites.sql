...
select
    ...
    round(
        approx_quantiles(notification_permission_deny, 1000 respect nulls)[offset(100)],
        3
    ) as notification_permission_deny_10th_percentile,
    round(
        approx_quantiles(notification_permission_deny, 1000 respect nulls)[offset(250)],
        3
    ) as notification_permission_deny_25th_percentile,
    round(
        approx_quantiles(notification_permission_deny, 1000 respect nulls)[offset(500)],
        3
    ) as notification_permission_deny_50th_percentile,
    round(
        approx_quantiles(notification_permission_deny, 1000 respect nulls)[offset(750)],
        3
    ) as notification_permission_deny_75th_percentile,
    round(
        approx_quantiles(notification_permission_deny, 1000 respect nulls)[offset(900)],
        3
